...
export default function LandClearingExcavationPage() {
  ...
  return (
    <Layout
      title={
        'Ultra Demolition | Demolition Contractor | Land Clearing and Excavation Services'
      }>
      {/* Hero */}
      <div className='relative bg-white h-3/4 py-12 md:py-24'>
        <div className='absolute inset-0'>
          <Image
            ...
            src='/images/land-clearing/3-land-clearing-excavation.webp'
            layout='fill'
            objectFit='cover'
            priority={true}
            placeholder='blur'
            blurDataURL
            alt='Land CLearing and Excavation Services'
          />
          <div
      ...
      <div className='bg-blue-500'>
            ...
            <div className='flex flex-col items-start max-w-xl'>
              <h2 className='text-2xl font-extrabold text-white'>
                <span className='block'>
                  Let Us Prepare Your Site by Clearing the Land
                </span>
              </h2>
              <p className='mt-4 text-lg leading-6 text-white source-styles'>
                If you want to ensure that your site is free of debris such as
                fallen trees, branches, and rocks before you begin your new
                construction project, hire the professionals at Ultra Demolition
                to get the job done right. Count on us to handle the site
                preparation for all sizes of residential and commercial
                construction projects. We take pride in our work and are
                committed to providing results of superior quality.
              </p>

              <p className='text-2xl font-extrabold text-white pt-10 pb-4'>
                Get Exceptional Excavation Services From Us
              </p>
              <p className=' text-lg leading-6 text-white source-styles'>
                When you need reliable professionals who are experienced in
                providing quality excavation services, you don&apos;t have to
                look any further than us. We provide all our services at
                competitive prices and strive to ensure your complete
                satisfaction.
              </p>

              <p className='text-white text-md source-styles pt-4'>
                <Link href='/contact'>
                  <a className='underline hover:text-blue-700'>Contact</a>
                </Link>
                {''} us for a FREE estimate, and we&apos;ll provide it to you
                within 24 hours.
              </p>
            </div>
            {/* Second Div */}
		...
		c-0.737,0-1.333,0.597-1.333,1.333v5.333C420.333-161.929,420.93-161.333,421.667-161.333z'></path>
                  ...
                  <p className='text-2xl mb-3 font-bold'>
                    Get Your Construction Site Prepared by Us
                  </p>

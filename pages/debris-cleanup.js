...
export default function DebrisCleanupPage() {
  ...
  return (
    <Layout title={'Ultra Demolition | Demolition Contractor | Debris Cleanup'}>
      {/* Hero */}
      <div className='relative bg-white h-3/4 py-12 md:py-24'>
        <div className='absolute inset-0'>
          <Image
            className='w-full h-full object-cover'
            src='/images/debris/4-debris-cleanup-hero.webp'
            layout='fill'
            objectFit='cover'
            priority={true}
            placeholder='blur'
            blurDataURL
            alt='Residential and Commercial Cleanup'
          />
          <div
      ...
      <div className='bg-blue-500'>
            ...
            <div className='flex flex-col items-start max-w-xl'>
              <h2 className='text-2xl font-extrabold text-white'>
                <span className='block'>
                  Construction Site and Yard Debris Removal
                </span>
              </h2>
              <p className='mt-4 text-lg leading-6 text-white source-styles'>
                Are you looking for a contractor who can remove the debris from
                your construction site or fallen trees and leaves from your
                yard? Then choosing Ultra Demolition is your best option. Rest
                assured that we&apos;ll provide quality debris cleanup and
                hauling services at affordable prices.
              </p>

              <p className='py-6 text-lg leading-6 text-white source-styles'>
                Our yard cleanup will be so perfect that it will look like there
                wasn&apos;t any debris on it before. Trust us to make your yard
                look like new. We also provide debris cleanup services as a part
                of hurricane relief.{' '}
                <Link href='/contact'>
		...
		c-0.737,0-1.333,0.597-1.333,1.333v5.333C420.333-161.929,420.93-161.333,421.667-161.333z'></path>
                  ...
                  <p className='text-2xl mb-3 font-bold'>
                    Hire Us to Get Thorough Cleanup Services
                  </p>

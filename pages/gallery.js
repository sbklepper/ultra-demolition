...
const files = [
    ...
    ,
    {
        source: '/images/gallery/photo-gallery/67.webp',
        alt: 'Image 67',
    },
    {
        source: '/images/gallery/photo-gallery/68.webp',
        alt: 'Image 68',
    },
    {
        source: '/images/gallery/photo-gallery/69.webp',
        alt: 'Image 69',
    },
    {
        source: '/images/gallery/photo-gallery/70.webp',
        alt: 'Image 70',
    },
    {
        source: '/images/gallery/photo-gallery/71.webp',
        alt: 'Image 71',
    },
    {
        source: '/images/gallery/photo-gallery/72.webp',
        alt: 'Image 72',
    },
    {
        source: '/images/gallery/photo-gallery/73.webp',
        alt: 'Image 73',
    },
    {
        source: '/images/gallery/photo-gallery/74.webp',
        alt: 'Image 74',
    },
    {
        source: '/images/gallery/photo-gallery/75.webp',
        alt: 'Image 75',
    }
]
                            ...
                            <ul
                                ...
                                {files.map((file) => (
                                    <li key={file.source} className='relative'>
                                        <div
                                            className='group block w-full h-auto aspect-w-5 aspect-h-7 focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-offset-gray-100 focus-within:ring-indigo-500 overflow-hidden'>
                                            <a href={file.source}>
                                                <Image
                                                    src={file.source}
                                                    height={250}
